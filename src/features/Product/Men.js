...
export default function Men() {
  return (
    <section className="container mx-auto bg-white p-5 md:px-16">
      {/* heading */}
      <h2 className="font-poppins font-bold text-3xl py-10">Men's Clothing</h2>
      {/* Filters */}
      <Disclosure
        as="section"
        className="z-10 border-t border-b border-gray-200 grid items-center"
      >
        <div className="relative col-start-1 row-start-1 py-4">
          <div className="max-w-7xl mx-auto flex space-x-6 text-sm">
      ...
      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        {dataProducts.map((product, index) => (
          <div key={index} className="flex flex-col gap-3 group relative cursor-pointer">
            ...
            <div className="flex justify-between items-center">
              ...
              <button className="flex text-sm font-medium text-gray-900 px-3 py-2 bg-dark-light rounded-lg cursor-pointer">
                <span>$</span>
                <p>{product.price}</p>
              </button>
            </div>
