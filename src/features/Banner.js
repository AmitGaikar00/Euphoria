  ...
  return (
    <section className="w-full h-screen relative bg-[#01b7dc] md:bg-white">
      ...
      <div className="absolute top-1/3 left-1/4 -translate-y-1/3 -translate-x-1/4 text-white flex flex-col justify-between gap-7">
        <h2 className="font-semibold text-xl md:text-2xl">T-Shirt/ Tops</h2>
        <h1 className="font-bold text-4xl md:text-6xl max-w-sm">
          Summer Value Pack
        </h1>
        <h2 className="font-semibold text-2xl">cool / colourful / comfy</h2>
        <div>
